...
//
//        }; // 创建背景图片对象
//        ImageIcon icon=new ImageIcon("src/pause.png");
//        PausePanel icon=new PausePanel();
...
//        label.setBounds(0, 0, icon.getIconWidth(), icon.getIconHeight()); // 设置组件的显示位置及大小
        ...
        JFrame Pauseframe = new JFrame("PausePanel");
        //设置在屏幕的位置
...
//        Pauseframe.getLayeredPane().add(label,new Integer(Integer.MIN_VALUE));
        ...
        pausePanel.add(button5);
        pausePanel.add(button6);
        pausePanel.add(button7);
        pausePanel.add(button8);
        ...
        button8.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int n=JOptionPane.showConfirmDialog(null,"你的得分是","GAME OVER",JOptionPane.DEFAULT_OPTION);
            }});

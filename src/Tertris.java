...
public class Tertris extends JPanel implements KeyListener{
    ...
    public void initPausePanel(JPanel panel,music music){
        ...
        ImageIcon icon = new ImageIcon("2.jpeg"); // 创建背景图片对象
        ...
        button8.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int n=JOptionPane.showConfirmDialog(null,"游戏结束","你的得分是",JOptionPane.DEFAULT_OPTION);
            }});
    ...
    //开始游戏的方法
    public void game_begin(JPanel panel) {
//        while(isStart == false);
        isrunning=true;
        //game_clear(panel);
        int flag = 0;
            ...
            this.setVisible(false);
            if(flag == 0) {
                GameoverFrame gameoverFrame = new GameoverFrame(panel);
                gameoverFrame.setVisible(true);
            }
            game_clear(this);
            //game_begin(panel);
